                    ...
                    <div class="card-body">
                        <form action="inserir.php" method="post">
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="posts" role="tabpanel" aria-labelledby="posts-tab">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="message" name="txtPost" rows="3" placeholder="O que esta pensando?"></textarea>
                                    </div>
                            ...
                            <div class="btn-toolbar justify-content-between">
                                <div class="btn-group">
                                    <button type="submit" name="btnCompartilhar" class="btn btn-primary">Compartilhar</button>
                                </div>
                                <div class="btn-group">
